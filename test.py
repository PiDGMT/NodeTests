...
##hier loop ik over alle scenemarks in die lijst van Andre. de --second-scenemark moer hiervoor op True staan
for scenemarkvid in os.listdir("payloads/SceneMark_SMK_00000004-63a1-fcb9-8002-0000000000a4_0001-2022-01-12"):
    
    scenemarkvid = "payloads/SceneMark_SMK_00000004-63a1-fcb9-8002-0000000000a4_0001-2022-01-12" + "/" + scenemarkvid ##hele path
    ...
    def send_payload_to_node():
        ...
        node_payload = generate_node_payload(
            ...
            "RGBStill",
            rsa_private_key,
            scenemarkvid, ##hier heb ik scenemarkvid toegevoegd als variabele (staat in utils)
            CUSTOM,
            SECOND_SCENEMARK,
            'dummy-access-token'
            )
    ...
    def send_payload_to_node():
        ...
        node_payload = generate_node_payload(
            ...
            CUSTOM,
            SECOND_SCENEMARK,
            scenemarkvid, ##hier is ie ook toegevoegd
            'dummy-access-token'
            )
